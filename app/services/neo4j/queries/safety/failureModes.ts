...
export const getFailuresForSwComponents = async (swComponentUuid: string): Promise<{
  ...
  try {    const query = `
      ...
      AND (swComponent:APPLICATION_SW_COMPONENT_TYPE OR swComponent:COMPOSITION_SW_COMPONENT_TYPE OR swComponent:ECU_ABSTRACTION_SW_COMPONENT_TYPE OR swComponent:SERVICE_SW_COMPONENT_TYPE)
      RETURN 
        failureMode.uuid AS failureModeUuid,
        failureMode.name AS failureModeName,
        failureMode.description AS failureModeDescription,
...
export const getFailuresAndCountsForComponents = async (
  ...
  try {
    const query = `
      ...
      AND (swc:APPLICATION_SW_COMPONENT_TYPE OR swc:COMPOSITION_SW_COMPONENT_TYPE OR swc:ECU_ABSTRACTION_SW_COMPONENT_TYPE OR swc:SERVICE_SW_COMPONENT_TYPE)
...
export const getFailuresAndCountsForComponent = async (
  ...
  try {
    const query = `
      ...
      WHERE (swc:APPLICATION_SW_COMPONENT_TYPE OR swc:COMPOSITION_SW_COMPONENT_TYPE OR swc:ECU_ABSTRACTION_SW_COMPONENT_TYPE OR swc:SERVICE_SW_COMPONENT_TYPE)
