...
import SafetyAnalysisExportLink from './components/SafetyAnalysisExportLink';
import SafetyStatistics from './components/SafetyStatistics';
import AsilCheckLink from './components/AsilCheckLink';
...
const SafetyDataExchangePage: React.FC = () => {
    ...
    },
    {
      ...
      children: (
        <Space direction="vertical" style={{ width: '100%' }} size={24}>
          ...
          <Card title="Check ASIL mismatch for the failure net">
            <Space direction="vertical" style={{ width: '100%' }}>
              <AsilCheckLink />
              <Paragraph style={{ margin: 0, fontSize: '14px', color: '#666' }}>
                Analyze ASIL level consistency between cause and effect failure modes in causation relationships.
                Identifies critical mismatches where lower ASIL failure modes propagate to higher ASIL ratings.
              </Paragraph>
            </Space>
          </Card>
  ...
  return (
    <div style={{ padding: 24 }}>
      <Title level={2}>Export, Import and Check the Safety Analysis</Title>
      <Paragraph>
        Export safety analysis data from Neo4j or import it from a JSON file. Perform ASIL consistency checks on the data.
      </Paragraph>
      {/* DB Status Button */}
      ...
      <Tabs
        items={tabItems}
        defaultActiveKey="graph-as-code"
      />
...
export default SafetyDataExchangePage;
